        ...
        <div className="container px-5 py-2">
          <div className="payment-page">
            ...
            {orders.length === 0 ? (
              ...
              <img style={{marginTop:200}} src="https://cdn2.cellphones.com.vn/x,webp/media/cart/Cart-empty-v2.png"></img>
              <p className="">
              ...
              <div key={index} className="Order-body my-4">
                ...
                >
                  ...
                  <div style={{ padding: 0 }} className="col-md-6 d-flex">
                    ...
                    <li>{order.isDelivered ? 'Đã giao hàng' : 'Chưa xác nhận'}</li>
                      <div
                        style={{
                          height: 13,
                          width: 1,
                      ...
                      ></div>
                       <li>{order.isPaid ? 'Đã thanh toán' : 'Chưa thanh toán'}</li>
                    </ul>
                  </div>
                </div>
                  ...
                  return (
                    ...
                    >
                      <div style={{ padding: 0 }} className="col-md-2">
                        <img src={imageUrl} style={{ width: 70, height: 70 }} alt={item.name}></img>
                      </div>
                ...
                <div style={{ marginTop: 20 }} className="row">
                  <div className="col-md-5 d-flex">
                    <div >
                      <p className="title-info2">Họ Tên:</p>
                ...
                <div className="row flex float-right py-2">
                  <div
                    ...
                    className="col-md-6 d-flex total-orders"
                  >
                    <div
                    ...
                    >
                      <img
                        ...
                        alt="Logo"
                      />
                      <p style={{ fontSize: 16, margin: 0 }}>Tổng số tiền:</p>
                    </div>
                    <div>
                      <p
                        style={{
